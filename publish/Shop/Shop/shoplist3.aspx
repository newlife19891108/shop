<%@ page language="C#" masterpagefile="~/zt.master" autoeventwireup="true" inherits="shoplist3, App_Web__q-vcgqn" title="恭喜，订单提交成功了！" %>
...
<%-- %><div style="  font-size:22px; color:##450b0b;">恭喜，订单提交成功了！</div><br />--%>
...
<tr><td style="text-align:left;color:#450b0b;  border:0;">请点击以下银行支付：</td></tr>
<tr>
<td>
...
<tr><td style="text-align:left;color:#450b0b;  border:0;">请选择以下支付平台支付：</td></tr>
<tr>
<td>
