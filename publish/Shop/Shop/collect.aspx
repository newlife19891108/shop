<%@ page language="C#" masterpagefile="~/AccountCenter.master" autoeventwireup="true" enableeventvalidation="false" inherits="collect, App_Web_jerbo5fe" title="收藏夹" %>
 ...
 <div class="tit"><span>我的订单</span></div>
        <div class="main">
          <table class="table center tab_x1">
            <tbody><tr class="tr_h">
              <td class="tab_l_width" style="background-color:#450b0b; color:#ffffff; width: 90px">商品图片</td>
              <td style="background-color:#450b0b;  color:#ffffff;">商品名称</td>
              <td style="background-color:#450b0b;  color:#ffffff;">商品价格</td>
              <td style="background-color:#450b0b;  color:#ffffff;">删除</td>
            </tr>
