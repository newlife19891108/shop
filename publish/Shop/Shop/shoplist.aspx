<%@ page language="C#" masterpagefile="~/zt.master" autoeventwireup="true" inherits="shoplist, App_Web_dvo2crpa" title="购物车" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div  class="shoplist">
<div><img src="images/pay_setp_01.jpg" /></div>
...
<div style=" text-align:right; padding:15px;">
    <asp:ImageButton ID="buy" runat="server"  ImageUrl="images/but_buy_con.jpg" 
        onclick="buy_Click"/>
    <asp:ImageButton ID="pay" runat="server"  ImageUrl="images/but_buy_now.jpg" 
        onclick="pay_Click"/>
