        <%@ page language="C#" masterpagefile="~/zt.master" autoeventwireup="true" validaterequest="false" inherits="shoplist2, App_Web__q-vcgqn" title="核对信息" %>
...
<div>
    <div style="text-align:right; padding-right:25px; padding-top:15px;">
        <asp:ImageButton ID="ImageButton1" runat="server"  
            ImageUrl="images/btn_submit1.jpg" onclick="ImageButton1_Click" /></div>
           </div>
        </div>
