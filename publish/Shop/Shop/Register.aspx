<%@ page language="C#" masterpagefile="~/zt.master" autoeventwireup="true" enableviewstate="false" inherits="Register, App_Web_vblrsmn6" title="会员注册" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="re_zt">
        <div class="re_zt_t"><img src="images/注册标题.jpg"  alt=""/></div>
        <div>
...
&nbsp;<span class="mess_pop_2"><span id="username_notice" class="bg_l "><span class="clear"></span></span></span></td>
                          ...
                          <td class="style1">
                            <%--<input name="Submit" src="images/but_reg.gif" id="submit" type="image" />  --%>            
                              <asp:ImageButton ID="ImageButton1" runat="server" 
                                  ImageUrl="~/images/注册.jpg"  Height="35px" Width="98px" 
                        ...
                        <tr>
                          ...
                          <td>
                            <br/>
                            <img class="b_5" src="images/ico_04.gif" alt=""/>我已有账号，我要&nbsp;<a href="Login.aspx"style="color: #450b0b;">登录<br/>
                           </td>
                        </tr>
                      </tbody></table>
            </div>
