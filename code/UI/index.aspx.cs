...
public partial class index : System.Web.UI.Page
{
    ...
    {
        Page.Title = "江高原汽车配件网-www.jgyyp.com-品质最好的汽车配件";
        
        HtmlMeta myMeta = new HtmlMeta();
        myMeta.Name = "Keywords";
        myMeta.Content = "女装,配件,原原网,Hichoose.com";
        this.Header.Controls.Add(myMeta);

        HtmlMeta myMeta1 = new HtmlMeta();
        myMeta1.Name = "Description";
        myMeta1.Content = "原原网（Hichoose.com)成立于2009年，凭借自身在配件行业多年打拼所积累的经验，全力拓展新兴电子商务市场。大学生作为中国最具想象力的群体，还有很多可以与之共创梦想的基点，相信，在这块热土上值得我们共同去开垦，去开创属于我们的天空。我们还很年轻，但我们有来自全国最具创意的团队；我们还不成熟，但我们拥有最具创业精髓的理念；我们还很稚嫩，但我们愿意与你在历练风雨后共同成长。我们坚信，原原网（Hichoose.com）一定会成为中国大学生喜爱的配件购物平台。";
        ...
        myMeta2.Name = "Author";
        myMeta2.Content = "原原网,Hichoose.com";
